...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Trihardcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"trihardcointools.com", "dnsseed.trihardcointools.com"},
    {"trihardcoinpool.org", "dnsseed.trihardcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"trihardcointools.com", "testnet-seed.trihardcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Trihardcoin is probably already running."), addrBind.ToString().c_str());
        else
